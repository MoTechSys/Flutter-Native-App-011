...
class _AboutScreenState extends State<AboutScreen> {
  ...
  static const List<int> _b = [
    77, 111, 84, 101, 99, 104, 83, 121, 115, 32, 45, 32, 66, 117, 105, 108,
    100, 32, 83, 105, 103, 110, 97, 116, 117, 114, 101
  ];
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            const Center(
              child: Text('CarCare - سجل السيارة الذكي',
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: const [
                    ...
                    _Row(Icons.school, 'نوع المشروع', 'مشروع نصف الترم - Flutter'),
                    Divider(color: Colors.white12, height: 24),
